...
export default function IconDefault({
    ...
    switch (type) {
        case 'sun':
            return <FaSun className={css} />
        case 'road':
            return <FaRoad className={css} />
        case 'tree':
            return <FaTree className={css} />
        case 'tools':
            return <FaTools className={css} />
        case 'corporate':
            return <FaBriefcase className={css} />
        case 'home':
            return <FaHome className={css} />
        case 'carpet':
            return <FaCouch className={css} />
        case 'office':
            return <FaBuilding className={css} />
        case 'window':
            return <FaWindowMaximize className={css} />
        case 'add':
